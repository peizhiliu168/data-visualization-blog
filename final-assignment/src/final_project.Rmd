...
countries_waste_mapping %>%
  ...
  geom_sf() + 
  scale_fill_gradientn(colors = rev(rainbow(7)[-7]), name = "Metric Tonnes", trans = "log") + 
  new_scale_fill() + 
...
proportion_data %>%
  ...
  scale_fill_discrete(labels=c("Synthetic Textiles", "Tyres", "Road Markings", "Marine Coatings", "Personal Care Products", "Plast Pellets")) + 
  t
